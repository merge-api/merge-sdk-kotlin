...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun tasksList(requestModel: TasksApi.TasksListRequest): HttpResponse<MergePaginatedResponse<Task>> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun tasksRetrieve(requestModel: TasksApi.TasksRetrieveRequest): HttpResponse<Task> {
