...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun stagesList(requestModel: StagesApi.StagesListRequest): HttpResponse<MergePaginatedResponse<Stage>> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun stagesRetrieve(requestModel: StagesApi.StagesRetrieveRequest): HttpResponse<Stage> {
