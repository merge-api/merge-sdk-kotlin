 ...
 * Values: READ,WRITE
 */
enum class EnabledActionsEnum(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is EnabledActionsEnum) "$data" else null

        /**
         * Returns a valid [EnabledActionsEnum] for [data], MERGE_NONSTANDARD_VALUE otherwise
         */
        fun decode(data: kotlin.Any?): EnabledActionsEnum = data?.let {
