 ...
 */
enum class OriginTypeEnum(val value: kotlin.String) {
    ...
    @JsonProperty(value = "CUSTOM_OBJECT")
    CUSTOM_OBJECT("CUSTOM_OBJECT"),


    @JsonProperty(value = "COMMON_MODEL")
    COMMON_MODEL("COMMON_MODEL"),


    @JsonProperty(value = "REMOTE_ONLY_MODEL")
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is OriginTypeEnum) "$data" else null

        /**
         * Returns a valid [OriginTypeEnum] for [data], MERGE_NONSTANDARD_VALUE otherwise
         */
        fun decode(data: kotlin.Any?): OriginTypeEnum = data?.let {
