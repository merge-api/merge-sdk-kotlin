...
data class PatchedOpportunityRequest (
    ...
    companion object {
        @JvmStatic
        fun normalize(expanded: PatchedOpportunityRequest.Expanded): PatchedOpportunityRequest {
            return PatchedOpportunityRequest(
