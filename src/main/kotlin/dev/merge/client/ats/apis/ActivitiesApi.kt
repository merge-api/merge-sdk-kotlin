...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun activitiesList(requestModel: ActivitiesApi.ActivitiesListRequest): HttpResponse<MergePaginatedResponse<Activity>> {
        ...
        requestModel.userId?.apply { localVariableQuery["user_id"] = listOf("$requestModel?.userId") }
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun activitiesRetrieve(requestModel: ActivitiesApi.ActivitiesRetrieveRequest): HttpResponse<Activity> {
