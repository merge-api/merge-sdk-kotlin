...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun scorecardsList(requestModel: ScorecardsApi.ScorecardsListRequest): HttpResponse<MergePaginatedResponse<Scorecard>> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun scorecardsRetrieve(requestModel: ScorecardsApi.ScorecardsRetrieveRequest): HttpResponse<Scorecard> {
