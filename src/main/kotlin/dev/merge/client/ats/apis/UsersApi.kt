...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun usersList(requestModel: UsersApi.UsersListRequest): HttpResponse<MergePaginatedResponse<RemoteUser>> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun usersRetrieve(requestModel: UsersApi.UsersRetrieveRequest): HttpResponse<RemoteUser> {
