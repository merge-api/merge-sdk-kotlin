...
import dev.merge.client.ats.models.EEOC
...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    data class EeocsRetrieveRequest (
    ...
    * Returns a list of &#x60;EEOC&#x60; objects.
     * @param candidateId If provided, will only return EEOC info for this candidate. (optional)
    ...
    */
    ...
    open suspend fun eeocsList(requestModel: EeocsApi.EeocsListRequest): HttpResponse<MergePaginatedResponse<EEOC>> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun eeocsRetrieve(requestModel: EeocsApi.EeocsRetrieveRequest): HttpResponse<EEOC> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
        RequestMethod.GET,
        "/eeocs/{id}".replace("{" + "id" + "}", "$requestModel.id"),
        query = localVariableQuery,
        headers = localVariableHeaders
        )
