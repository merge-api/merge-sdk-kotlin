...
data class ScheduledInterviewResponse (

    @field:JsonProperty("model")
    val model: ScheduledInterview,
    ...
    companion object {
        @JvmStatic
        fun normalize(expanded: ScheduledInterviewResponse.Expanded): ScheduledInterviewResponse {
