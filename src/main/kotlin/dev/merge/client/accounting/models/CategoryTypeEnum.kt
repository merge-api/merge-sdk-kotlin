 ...
 */
enum class CategoryTypeEnum(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is CategoryTypeEnum) "$data" else null

        /**
         * Returns a valid [CategoryTypeEnum] for [data], MERGE_NONSTANDARD_VALUE otherwise
         */
        fun decode(data: kotlin.Any?): CategoryTypeEnum = data?.let {
