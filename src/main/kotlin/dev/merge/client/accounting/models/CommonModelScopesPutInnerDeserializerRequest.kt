...
import dev.merge.client.accounting.models.CommonModelScopesPutInnerDeserializerEnabledActionsEnum
...
data class CommonModelScopesPutInnerDeserializerRequest (

    @field:JsonProperty("model_id")
    val modelId: kotlin.String,

    @field:JsonProperty("enabled_actions")
    val enabledActions: kotlin.collections.List<CommonModelScopesPutInnerDeserializerEnabledActionsEnum>,
    ...
    companion object {
        @JvmStatic
        fun normalize(expanded: CommonModelScopesPutInnerDeserializerRequest.Expanded): CommonModelScopesPutInnerDeserializerRequest {
            return CommonModelScopesPutInnerDeserializerRequest(
