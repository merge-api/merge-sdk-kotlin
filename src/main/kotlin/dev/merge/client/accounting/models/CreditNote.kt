 ...
 * @param status The credit note's status.  * `SUBMITTED` - SUBMITTED * `AUTHORIZED` - AUTHORIZED * `PAID` - PAID
...
data class CreditNote (
    ...
    val remainingCredit: kotlin.Double? = null,
