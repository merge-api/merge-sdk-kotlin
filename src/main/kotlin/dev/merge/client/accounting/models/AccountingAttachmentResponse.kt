...
data class AccountingAttachmentResponse (

    @field:JsonProperty("model")
    val model: AccountingAttachment,
    ...
    companion object {
        @JvmStatic
        fun normalize(expanded: AccountingAttachmentResponse.Expanded): AccountingAttachmentResponse {
