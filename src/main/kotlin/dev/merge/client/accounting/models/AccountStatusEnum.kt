 ...
 */
enum class AccountStatusEnum(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is AccountStatusEnum) "$data" else null

        /**
         * Returns a valid [AccountStatusEnum] for [data], MERGE_NONSTANDARD_VALUE otherwise
         */
        fun decode(data: kotlin.Any?): AccountStatusEnum = data?.let {
