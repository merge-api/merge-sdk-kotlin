...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun expensesList(requestModel: ExpensesApi.ExpensesListRequest): HttpResponse<MergePaginatedResponse<Expense>> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun expensesRetrieve(requestModel: ExpensesApi.ExpensesRetrieveRequest): HttpResponse<Expense> {
