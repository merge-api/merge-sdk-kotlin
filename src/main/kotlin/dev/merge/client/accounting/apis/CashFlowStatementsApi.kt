...
import dev.merge.client.accounting.models.CashFlowStatement
...
open class CashFlowStatementsApi(
...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    data class CashFlowStatementsListRequest (
    ...
    data class CashFlowStatementsRetrieveRequest (
    ...
    * Returns a list of &#x60;CashFlowStatement&#x60; objects.
     * @param companyId If provided, will only return cash flow statements for this company. (optional)
    ...
    */
    ...
    open suspend fun cashFlowStatementsList(requestModel: CashFlowStatementsApi.CashFlowStatementsListRequest): MergePaginatedResponse<CashFlowStatement> {
    ...
    /**
     * @param companyId If provided, will only return cash flow statements for this company. (optional) * @param createdAfter If provided, will only return objects created after this datetime. (optional) * @param createdBefore If provided, will only return objects created before this datetime. (optional) * @param cursor The pagination cursor value. (optional) * @param includeDeletedData Whether to include data that was marked as deleted by third party webhooks. (optional) * @param includeRemoteData Whether to include the original data Merge fetched from the third-party to produce these models. (optional) * @param modifiedAfter If provided, will only return objects modified after this datetime. (optional) * @param modifiedBefore If provided, will only return objects modified before this datetime. (optional) * @param pageSize Number of results to return per page. (optional) * @param remoteId The API provider&#39;s ID for the given object. (optional)
    */
    @Suppress("UNCHECKED_CAST")
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun cashFlowStatementsRetrieve(requestModel: CashFlowStatementsApi.CashFlowStatementsRetrieveRequest): CashFlowStatement {
    ...
    */
    ...
    private suspend inline fun <reified T> cashFlowStatementsRetrieveImpl(requestModel: CashFlowStatementsApi.CashFlowStatementsRetrieveRequest): T {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
        RequestMethod.GET,
        "/cash-flow-statements/{id}".replace("{" + "id" + "}", "${ requestModel.id }"),
        query = localVariableQuery,
        headers = localVariableHeaders
        )
