...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun attachmentsList(requestModel: AttachmentsApi.AttachmentsListRequest): HttpResponse<MergePaginatedResponse<AccountingAttachment>> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun attachmentsRetrieve(requestModel: AttachmentsApi.AttachmentsRetrieveRequest): HttpResponse<AccountingAttachment> {
