...
import dev.merge.client.accounting.models.Item
...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    data class ItemsRetrieveRequest (
    ...
    * Returns a list of &#x60;Item&#x60; objects.
     * @param companyId If provided, will only return items for this company. (optional)
    ...
    */
    ...
    open suspend fun itemsList(requestModel: ItemsApi.ItemsListRequest): MergePaginatedResponse<Item> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun itemsRetrieve(requestModel: ItemsApi.ItemsRetrieveRequest): Item {
    ...
    */
    ...
    private suspend inline fun <reified T> itemsRetrieveImpl(requestModel: ItemsApi.ItemsRetrieveRequest): T {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
        RequestMethod.GET,
        "/items/{id}".replace("{" + "id" + "}", "${ requestModel.id }"),
        query = localVariableQuery,
        headers = localVariableHeaders
        )
