...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun purchaseOrdersList(requestModel: PurchaseOrdersApi.PurchaseOrdersListRequest): HttpResponse<MergePaginatedResponse<PurchaseOrder>> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun purchaseOrdersRetrieve(requestModel: PurchaseOrdersApi.PurchaseOrdersRetrieveRequest): HttpResponse<PurchaseOrder> {
