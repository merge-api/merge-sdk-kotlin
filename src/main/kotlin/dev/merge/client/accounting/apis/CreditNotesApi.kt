...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun creditNotesList(requestModel: CreditNotesApi.CreditNotesListRequest): HttpResponse<MergePaginatedResponse<CreditNote>> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun creditNotesRetrieve(requestModel: CreditNotesApi.CreditNotesRetrieveRequest): HttpResponse<CreditNote> {
