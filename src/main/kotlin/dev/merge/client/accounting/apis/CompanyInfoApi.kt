...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun companyInfoList(requestModel: CompanyInfoApi.CompanyInfoListRequest): HttpResponse<MergePaginatedResponse<CompanyInfo>> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun companyInfoRetrieve(requestModel: CompanyInfoApi.CompanyInfoRetrieveRequest): HttpResponse<CompanyInfo> {
