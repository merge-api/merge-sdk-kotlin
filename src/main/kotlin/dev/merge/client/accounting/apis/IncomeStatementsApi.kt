...
import dev.merge.client.accounting.models.IncomeStatement
...
open class IncomeStatementsApi(
...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    data class IncomeStatementsListRequest (
    ...
    data class IncomeStatementsRetrieveRequest (
    ...
    * Returns a list of &#x60;IncomeStatement&#x60; objects.
     * @param companyId If provided, will only return income statements for this company. (optional)
    ...
    */
    ...
    @Suppress("UNCHECKED_CAST")
    open fun incomeStatementsListAsync(requestModel: IncomeStatementsApi.IncomeStatementsListRequest): CompletableFuture<MergePaginatedResponse<IncomeStatement>> = GlobalScope.future {
        incomeStatementsList(requestModel)
    }

    /**
     * @param companyId If provided, will only return income statements for this company. (optional) * @param createdAfter If provided, will only return objects created after this datetime. (optional) * @param createdBefore If provided, will only return objects created before this datetime. (optional) * @param cursor The pagination cursor value. (optional) * @param includeDeletedData Whether to include data that was marked as deleted by third party webhooks. (optional) * @param includeRemoteData Whether to include the original data Merge fetched from the third-party to produce these models. (optional) * @param modifiedAfter If provided, will only return objects modified after this datetime. (optional) * @param modifiedBefore If provided, will only return objects modified before this datetime. (optional) * @param pageSize Number of results to return per page. (optional) * @param remoteId The API provider&#39;s ID for the given object. (optional)
    */
    @Suppress("UNCHECKED_CAST")
    ...
    @Suppress("UNCHECKED_CAST")
    open fun incomeStatementsListExpandedAsync(requestModel: IncomeStatementsApi.IncomeStatementsListRequest): CompletableFuture<MergePaginatedResponse<IncomeStatement.Expanded>> = GlobalScope.future {
        incomeStatementsListExpanded(requestModel)
    }
    ...
    */
    ...
    @Suppress("UNCHECKED_CAST")
    open fun incomeStatementsRetrieveAsync(requestModel: IncomeStatementsApi.IncomeStatementsRetrieveRequest): CompletableFuture<IncomeStatement> = GlobalScope.future {
        incomeStatementsRetrieve(requestModel)
    }
    ...
    */
    ...
    @Suppress("UNCHECKED_CAST")
    open fun incomeStatementsRetrieveExpandedAsync(requestModel: IncomeStatementsApi.IncomeStatementsRetrieveRequest): CompletableFuture<IncomeStatement.Expanded> = GlobalScope.future {
        incomeStatementsRetrieveExpanded(requestModel)
    }
    ...
    private suspend inline fun <reified T> incomeStatementsRetrieveImpl(requestModel: IncomeStatementsApi.IncomeStatementsRetrieveRequest): T {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
        RequestMethod.GET,
        "/income-statements/{id}".replace("{" + "id" + "}", "${ requestModel.id }"),
        query = localVariableQuery,
        headers = localVariableHeaders
        )
