...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun balanceSheetsList(requestModel: BalanceSheetsApi.BalanceSheetsListRequest): HttpResponse<MergePaginatedResponse<BalanceSheet>> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun balanceSheetsRetrieve(requestModel: BalanceSheetsApi.BalanceSheetsRetrieveRequest): HttpResponse<BalanceSheet> {
