 ...
 */
enum class TriggerTypeEnum(val value: kotlin.String) {
    ...
    @JsonProperty(value = "TRIGGER_EVENT")
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is TriggerTypeEnum) "$data" else null

        /**
         * Returns a valid [TriggerTypeEnum] for [data], MERGE_NONSTANDARD_VALUE otherwise
         */
        fun decode(data: kotlin.Any?): TriggerTypeEnum = data?.let {
