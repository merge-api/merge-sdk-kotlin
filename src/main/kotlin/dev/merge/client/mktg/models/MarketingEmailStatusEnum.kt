 ...
 *
 * Values: DRAFT,QUEUED,SENT
 */
enum class MarketingEmailStatusEnum(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is MarketingEmailStatusEnum) "$data" else null

        /**
         * Returns a valid [MarketingEmailStatusEnum] for [data], MERGE_NONSTANDARD_VALUE otherwise
         */
        fun decode(data: kotlin.Any?): MarketingEmailStatusEnum = data?.let {
