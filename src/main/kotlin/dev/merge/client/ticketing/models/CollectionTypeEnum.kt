 ...
 * Values: LIST,PROJECT
 */
enum class CollectionTypeEnum(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is CollectionTypeEnum) "$data" else null

        /**
         * Returns a valid [CollectionTypeEnum] for [data], MERGE_NONSTANDARD_VALUE otherwise
         */
        fun decode(data: kotlin.Any?): CollectionTypeEnum = data?.let {
