...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    data class TicketsListRequest (
        ...
        val collectionIds: kotlin.String? = null,
    ...
    * Returns a list of &#x60;Ticket&#x60; objects.
     ...
     * @param collectionIds If provided, will only return tickets assigned to the collection_ids; multiple collection_ids can be separated by commas. (optional)
    ...
    */
    ...
    private suspend inline fun <reified T> ticketsListImpl(requestModel: TicketsApi.TicketsListRequest): T {
        ...
        val localVariableQuery = mutableMapOf<String, List<String>>()
            ...
            requestModel.collectionIds?.apply { localVariableQuery["collection_ids"] = listOf(this) }
