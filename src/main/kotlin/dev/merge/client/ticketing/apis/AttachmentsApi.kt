...
import dev.merge.client.ticketing.models.TicketingAttachmentEndpointRequest
import dev.merge.client.ticketing.models.TicketingAttachmentResponse
...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    data class AttachmentsCreateRequest (
        val ticketingAttachmentEndpointRequest: TicketingAttachmentEndpointRequest,
    ...
    */
    ...
    @Suppress("UNCHECKED_CAST")
    open fun attachmentsCreateAsync(requestModel: AttachmentsApi.AttachmentsCreateRequest): CompletableFuture<TicketingAttachmentResponse> = GlobalScope.future {
        attachmentsCreate(requestModel)
    }

    /**
     * @param ticketingAttachmentEndpointRequest   * @param isDebugMode Whether to include debug fields (such as log file links) in the response. (optional) * @param runAsync Whether or not third-party updates should be run asynchronously. (optional)
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun attachmentsCreateExpanded(requestModel: AttachmentsApi.AttachmentsCreateRequest): TicketingAttachmentResponse.Expanded {
        return attachmentsCreateImpl(requestModel)
    }

    @Suppress("UNCHECKED_CAST")
    open fun attachmentsCreateExpandedAsync(requestModel: AttachmentsApi.AttachmentsCreateRequest): CompletableFuture<TicketingAttachmentResponse.Expanded> = GlobalScope.future {
    ...
    private suspend inline fun <reified T> attachmentsCreateImpl(requestModel: AttachmentsApi.AttachmentsCreateRequest): T {
        ...
        val localVariableBody = requestModel.ticketingAttachmentEndpointRequest
    ...
    */
    ...
    private suspend inline fun <reified T> attachmentsListImpl(requestModel: AttachmentsApi.AttachmentsListRequest): T {
        ...
        val localVariableQuery = mutableMapOf<String, List<String>>()
            ...
            requestModel.ticketId?.apply { localVariableQuery["ticket_id"] = listOf(this) }
