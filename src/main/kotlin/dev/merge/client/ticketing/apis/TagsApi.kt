...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    data class TagsRetrieveRequest (
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun tagsRetrieve(requestModel: TagsApi.TagsRetrieveRequest): Tag {
        return tagsRetrieveImpl(requestModel)
    }

    @Suppress("UNCHECKED_CAST")
    open fun tagsRetrieveAsync(requestModel: TagsApi.TagsRetrieveRequest): CompletableFuture<Tag> = GlobalScope.future {
        tagsRetrieve(requestModel)
    }
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun tagsRetrieveExpanded(requestModel: TagsApi.TagsRetrieveRequest): Tag.Expanded {
        return tagsRetrieveImpl(requestModel)
    }

    @Suppress("UNCHECKED_CAST")
    open fun tagsRetrieveExpandedAsync(requestModel: TagsApi.TagsRetrieveRequest): CompletableFuture<Tag.Expanded> = GlobalScope.future {
        tagsRetrieveExpanded(requestModel)
    }

    private suspend inline fun <reified T> tagsRetrieveImpl(requestModel: TagsApi.TagsRetrieveRequest): T {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
        RequestMethod.GET,
        "/tags/{id}".replace("{" + "id" + "}", "${ requestModel.id }"),
        query = localVariableQuery,
        headers = localVariableHeaders
        )
