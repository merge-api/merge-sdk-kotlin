...
import dev.merge.client.hris.models.Team
...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    data class TeamsListRequest (
        ...
        val parentTeamId: kotlin.String? = null,
        val remoteId: kotlin.String? = null
    )

    data class TeamsRetrieveRequest (
    ...
    */
    ...
    private suspend inline fun <reified T> teamsListImpl(requestModel: TeamsApi.TeamsListRequest): T {
        ...
        val localVariableQuery = mutableMapOf<String, List<String>>()
            ...
            requestModel.parentTeamId?.apply { localVariableQuery["parent_team_id"] = listOf(this) }
    ...
    */
    ...
    private suspend inline fun <reified T> teamsRetrieveImpl(requestModel: TeamsApi.TeamsRetrieveRequest): T {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
        RequestMethod.GET,
        "/teams/{id}".replace("{" + "id" + "}", "${ requestModel.id }"),
        query = localVariableQuery,
        headers = localVariableHeaders
        )
