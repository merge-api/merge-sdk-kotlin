...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun companiesList(requestModel: CompaniesApi.CompaniesListRequest): HttpResponse<MergePaginatedResponse<Company>> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun companiesRetrieve(requestModel: CompaniesApi.CompaniesRetrieveRequest): HttpResponse<Company> {
