...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun employmentsList(requestModel: EmploymentsApi.EmploymentsListRequest): HttpResponse<MergePaginatedResponse<Employment>> {
        ...
        requestModel.orderBy?.apply { localVariableQuery["order_by"] = listOf("$requestModel?.orderBy") }
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun employmentsRetrieve(requestModel: EmploymentsApi.EmploymentsRetrieveRequest): HttpResponse<Employment> {
