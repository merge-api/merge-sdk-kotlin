...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun benefitsList(requestModel: BenefitsApi.BenefitsListRequest): HttpResponse<MergePaginatedResponse<Benefit>> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun benefitsRetrieve(requestModel: BenefitsApi.BenefitsRetrieveRequest): HttpResponse<Benefit> {
