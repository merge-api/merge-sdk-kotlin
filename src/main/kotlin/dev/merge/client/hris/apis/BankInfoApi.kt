...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun bankInfoList(requestModel: BankInfoApi.BankInfoListRequest): HttpResponse<MergePaginatedResponse<BankInfo>> {
        ...
        requestModel.accountType?.apply { localVariableQuery["account_type"] = listOf("$requestModel?.accountType") }
        requestModel.bankName?.apply { localVariableQuery["bank_name"] = listOf("$requestModel?.bankName") }
