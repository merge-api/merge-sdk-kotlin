...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun locationsList(requestModel: LocationsApi.LocationsListRequest): HttpResponse<MergePaginatedResponse<Location>> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun locationsRetrieve(requestModel: LocationsApi.LocationsRetrieveRequest): HttpResponse<Location> {
