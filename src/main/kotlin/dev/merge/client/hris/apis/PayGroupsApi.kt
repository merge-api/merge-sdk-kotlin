...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun payGroupsList(requestModel: PayGroupsApi.PayGroupsListRequest): HttpResponse<MergePaginatedResponse<PayGroup>> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun payGroupsRetrieve(requestModel: PayGroupsApi.PayGroupsRetrieveRequest): HttpResponse<PayGroup> {
