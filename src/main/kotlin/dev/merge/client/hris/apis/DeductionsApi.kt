...
json: ObjectMapper = ApiClient.JSON_DEFAULT,
    ...
    */
    ...
    open suspend fun deductionsList(requestModel: DeductionsApi.DeductionsListRequest): HttpResponse<MergePaginatedResponse<Deduction>> {
        ...
        requestModel.employeePayrollRunId?.apply { localVariableQuery["employee_payroll_run_id"] = listOf("$requestModel?.employeePayrollRunId") }
    ...
    */
    @Suppress("UNCHECKED_CAST")
    open suspend fun deductionsRetrieve(requestModel: DeductionsApi.DeductionsRetrieveRequest): HttpResponse<Deduction> {
