...
# **projectsUsersList**
> PaginatedUserList projectsUsersList(id, cursor, includeRemoteData, pageSize)
...
val pageSize : kotlin.Int = 56 // kotlin.Int | Number of results to return per page.
try {
    val result : PaginatedUserList = apiInstance.projectsUsersList(id, cursor, includeRemoteData, pageSize)
    println(result)
} catch (e: ClientException) {
