...
# **usersIgnoreCreate**
> IgnoreCommonModel usersIgnoreCreate(modelId, ignoreCommonModelRequest)
...
try {
    val result : IgnoreCommonModel = apiInstance.usersIgnoreCreate(modelId, ignoreCommonModelRequest)
    println(result)
