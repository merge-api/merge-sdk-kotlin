...
# **transactionsList**
> PaginatedTransactionList transactionsList(createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId)
...
try {
    val result : PaginatedTransactionList = apiInstance.transactionsList(createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId)
    println(result)
...
> Transaction transactionsRetrieve(id, includeRemoteData)
...
val includeRemoteData : kotlin.Boolean = true // kotlin.Boolean | Whether to include the original data Merge fetched from the third-party to produce these models.
try {
    val result : Transaction = apiInstance.transactionsRetrieve(id, includeRemoteData)
    println(result)
} catch (e: ClientException) {
