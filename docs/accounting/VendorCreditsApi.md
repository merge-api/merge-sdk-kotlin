...
# **vendorCreditsList**
> PaginatedVendorCreditList vendorCreditsList(createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId)
...
try {
    val result : PaginatedVendorCreditList = apiInstance.vendorCreditsList(createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId)
    println(result)
...
> VendorCredit vendorCreditsRetrieve(id, includeRemoteData)
...
val includeRemoteData : kotlin.Boolean = true // kotlin.Boolean | Whether to include the original data Merge fetched from the third-party to produce these models.
try {
    val result : VendorCredit = apiInstance.vendorCreditsRetrieve(id, includeRemoteData)
    println(result)
} catch (e: ClientException) {
