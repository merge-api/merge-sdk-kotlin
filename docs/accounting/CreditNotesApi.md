...
# **creditNotesList**
> PaginatedCreditNoteList creditNotesList(createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId)
...
try {
    val result : PaginatedCreditNoteList = apiInstance.creditNotesList(createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId)
    println(result)
...
# **creditNotesRetrieve**
> CreditNote creditNotesRetrieve(id, includeRemoteData, remoteFields)
...
val remoteFields : kotlin.String = status,type // kotlin.String | Which fields should be returned in non-normalized form.
try {
    val result : CreditNote = apiInstance.creditNotesRetrieve(id, includeRemoteData, remoteFields)
    println(result)
} catch (e: ClientException) {
