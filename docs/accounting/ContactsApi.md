...
# **contactsList**
> PaginatedContactList contactsList(companyId, createdAfter, createdBefore, cursor, expand, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId, showEnumOrigins)
...
val expand : kotlin.String = addresses,phone_numbers,company // kotlin.String | Which relations should be returned in expanded form. Multiple relation names should be comma separated without spaces.
...
try {
    val result : PaginatedContactList = apiInstance.contactsList(companyId, createdAfter, createdBefore, cursor, expand, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId, showEnumOrigins)
    println(result)
} catch (e: ClientException) {
 ...
 **expand** | **kotlin.String**| Which relations should be returned in expanded form. Multiple relation names should be comma separated without spaces. | [optional] [enum: addresses, addresses,company, addresses,phone_numbers, addresses,phone_numbers,company, company, phone_numbers, phone_numbers,company]
...
# **contactsRetrieve**
> Contact contactsRetrieve(id, expand, includeRemoteData, remoteFields, showEnumOrigins)
...
val showEnumOrigins : kotlin.String = status // kotlin.String | Which fields should be returned in non-normalized form.
try {
    val result : Contact = apiInstance.contactsRetrieve(id, expand, includeRemoteData, remoteFields, showEnumOrigins)
    println(result)
} catch (e: ClientException) {
