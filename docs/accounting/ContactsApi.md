...
# **contactsList**
> PaginatedContactList contactsList(createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId)
...
try {
    val result : PaginatedContactList = apiInstance.contactsList(createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId)
    println(result)
...
# **contactsRetrieve**
> Contact contactsRetrieve(id, includeRemoteData, remoteFields)
...
val remoteFields : kotlin.String = status // kotlin.String | Which fields should be returned in non-normalized form.
try {
    val result : Contact = apiInstance.contactsRetrieve(id, includeRemoteData, remoteFields)
    println(result)
} catch (e: ClientException) {
