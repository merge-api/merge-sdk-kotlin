...
# **paymentsList**
> PaginatedPaymentList paymentsList(accountId, contactId, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId)
...
try {
    val result : PaginatedPaymentList = apiInstance.paymentsList(accountId, contactId, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId)
    println(result)
...
# **paymentsRetrieve**
> Payment paymentsRetrieve(id, includeRemoteData)
...
val includeRemoteData : kotlin.Boolean = true // kotlin.Boolean | Whether to include the original data Merge fetched from the third-party to produce these models.
try {
    val result : Payment = apiInstance.paymentsRetrieve(id, includeRemoteData)
    println(result)
} catch (e: ClientException) {
