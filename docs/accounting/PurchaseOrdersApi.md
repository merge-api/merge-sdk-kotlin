...
# **purchaseOrdersList**
> PaginatedPurchaseOrderList purchaseOrdersList(companyId, createdAfter, createdBefore, cursor, expand, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId, showEnumOrigins)
...
val expand : kotlin.String = line_items,delivery_address,vendor // kotlin.String | Which relations should be returned in expanded form. Multiple relation names should be comma separated without spaces.
...
try {
    val result : PaginatedPurchaseOrderList = apiInstance.purchaseOrdersList(companyId, createdAfter, createdBefore, cursor, expand, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId, showEnumOrigins)
    println(result)
} catch (e: ClientException) {
 ...
 **expand** | **kotlin.String**| Which relations should be returned in expanded form. Multiple relation names should be comma separated without spaces. | [optional] [enum: delivery_address, delivery_address,vendor, line_items, line_items,delivery_address, line_items,delivery_address,vendor, line_items,vendor, vendor]
