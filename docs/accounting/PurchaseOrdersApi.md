...
# **purchaseOrdersList**
> PaginatedPurchaseOrderList purchaseOrdersList(createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId)
...
try {
    val result : PaginatedPurchaseOrderList = apiInstance.purchaseOrdersList(createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId)
    println(result)
...
> PurchaseOrder purchaseOrdersRetrieve(id, includeRemoteData, remoteFields)
...
val remoteFields : kotlin.String = status // kotlin.String | Which fields should be returned in non-normalized form.
try {
    val result : PurchaseOrder = apiInstance.purchaseOrdersRetrieve(id, includeRemoteData, remoteFields)
    println(result)
} catch (e: ClientException) {
